        ...
        <div className={isMobile ? "w-full max-w-[180px]" : "flex-1 max-w-md"}>
          <div className="relative w-full">
            ...
            <Input
              ...
              className="w-full bg-gray-50 border-gray-100 rounded-lg pl-8 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-legal-500 focus:border-transparent transition-all duration-200"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-1 sm:space-x-3">
        ...
        {!isMobile && (
          <div className="hidden sm:flex items-center px-3 py-1.5 bg-gray-50 rounded-lg border border-gray-100 shadow-sm">
            <Clock className="h-5 w-5 mr-2 text-legal-600" />
