...
export function Sidebar({ collapsed = false, onToggleCollapse }: SidebarProps) {
  return (
    <div className={cn(
      "bg-gradient-to-b from-blue-800 via-blue-900 to-blue-950 text-white h-screen flex flex-col border-r border-white/10 shadow-xl relative overflow-hidden",
      collapsed ? "w-24" : "w-72"
    )}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-blue-950/50 to-transparent"></div>
      ...
      <div className="relative z-10 flex flex-1 flex-col h-full overflow-hidden">
        ...
        <div className="flex-shrink-0 p-4 relative z-10">
          <div className="rounded-xl bg-gradient-to-r from-blue-700/30 to-blue-800/30 backdrop-blur-md p-4 border border-white/10 shadow-lg hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-blue-400/80 to-blue-500/80 flex items-center justify-center shadow-lg border border-white/20 group-hover:scale-105 transition-all duration-300">
